          ...
          <div className="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navmenu" className="navmenu">
              <ul>
                ...
                <li><a href="#" className="active">We Are Hiring</a></li>
        ...
        <main className="main">
          ...
          >
            <div className="container position-relative">
              <h1>We Are Hiring</h1>
              <p>
                Join our passionate team of educators and help shape the future—now hiring talented teachers and staff!
              </p>
          ...
          <div className="container mt-5 text-center">
            <div className="btn-group">
              {[
                ...
                <button
                  key={tab.id}
                  className={`btn custom-tab ${activeSection === tab.id ? "active" : ""}`}
        ...
        <div className="row align-items-center">
          <div className="col-lg-7">
            <div className="impact-content">
              ...
              <ul>
                <li><strong>Undergraduates:</strong> Final-year students ready to apply their learning in a practical environment.</li>
                <li><strong>Fresh Graduates:</strong> Recent graduates seeking meaningful, supportive early-career experience.</li>
                <li><strong>Career Shifters:</strong> Individuals (up to 30 years old) exploring a career change into education and administration.</li>
              </ul>
              ...
              <p>
                This internship is more than work experience—it’s a chance to make a real difference in students’ lives while building your own professional toolkit. If you are interested in applying, please fill in the form below and submit your CV. We look forward to discovering how your talents and aspirations might align with the goals of our school community.
              </p>
              <div className="impact-buttons">
                <a href="#" className="btn-donate">Apply Now</a>
              </div>
            </div>
          </div>
