        ...
        <div>
          ...
          <main className="main">
            ...
            <section
              ...
              className="campus-facilities section"
            >
              <div
                className="container"
                data-aos="fade-up"
                          ...
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-7">
                              ...
                              >
                                ...
                                board's collective vision focuses on expanding
                                our educational endeavors across the MENA
                                region, driven by a commitment to excellence and
                                innovation.
                              </p>
                              <p
                                style={{
                          ...
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-7">
                              ...
                              >
                                ...
                                <li>
                                  <strong>Knowledgeable:</strong> Students gain
                                  a deep understanding of important concepts,
                                  ideas, and issues that span traditional
                                  academic boundaries and civilizations.
                                </li>
                                <li>
                                  <strong>Thinkers:</strong> We encourage
                                  students to apply thinking skills critically
                                  and creatively to recognize and approach
                                  complex problems, and to make reasoned,
                                  ethical decisions.
                                </li>
                                <li>
                                  <strong>Communicators:</strong> Students learn
                                  to express themselves confidently and
                                  creatively in multiple languages and forms.
                                  They also learn to listen carefully to the
                                  perspectives of other individuals and groups.
                                </li>
                                <li>
                                  <strong>Principled:</strong> Our students act
                                  with integrity and honesty, with a strong
                                  sense of fairness and justice, and respect for
                                  the dignity and rights of people everywhere.
                                </li>
                                <li>
                                  <strong>Open-minded:</strong> Students
                                  appreciate their own cultures and personal
                                  histories, as well as the values and
                                  traditions of others. They seek to evaluate a
                                  range of points of view and are willing to
                                  grow from the experience.
                                </li>
                                <li>
                                  <strong>Caring:</strong> Our community
                                  encourages students to show empathy,
                                  compassion, and respect. They have a
                                  commitment to service and act to make a
                                  positive difference in the lives of others and
                                  in the world around them.
                                </li>
                                <li>
                                  <strong>Risk-takers:</strong> Students
                                  approach uncertainty with forethought and
                                ...
                                <li>
                                  ...
                                  the importance of balancing different aspects
                                  of their lives—intellectual, physical, and
                        ...
                        >
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-7">
                              ...
                              >
                                LIC campus is designed to foster an environment
                                of learning and personal growth. Located in the
                                heart of New Cairo, our school is situated in a
                                vibrant community that enriches the educational
                                experience of our students with a mix of
                                cultural, historical, and modern influences.
                                <a
                              ...
                              >
                                ...
                                <li>
                                  ...
                                  creative talents in visual and performing
                                  arts.
                                </li>
                                <li>
                                  <i className="bi bi-trophy text-primary me-2"></i>
                                  <strong>Sports Facilities:</strong> Including
                                  a swimming pool, gymnasium, sports fields, and
                                ...
                                <li>
                                  ...
                                  Spaces that encourage ecological learning and
                                  outdoor activities.
                                </li>
                                <li>
                                  <i className="bi bi-cup-straw text-primary me-2"></i>
                                  <strong>Cafeteria:</strong> Offering healthy
                                  and nutritious meal options in a comfortable
                                  dining environment.
                                </li>
                              </ul>
                              ...
                              >
                                ...
                                services that ensure convenient commutes for our
                                students and staff from surrounding areas. Ample
                                parking is available for families and visitors.
                              </p>
                              ...
                              >
                                Safety is paramount at LIC. Our campus is
                                equipped with comprehensive security measures,
                                including surveillance systems and controlled
                                gate access. Our dedicated security team is
                                on-site 24/7 to maintain a secure learning
                                environment.
                              </p>
                              ...
                              >
                                ...
                                environment that makes LIC a unique place to
                                learn and grow.
                              </p>
                            </div>
                          </div>
