                        ...
                        >
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-7">
                              ...
                              <div className="mb-4 d-block d-md-none" data-aos="fade-up">
                                <Image
                                  src="/assets/img/education/Governance.JPG"
                                  alt="Governance"
                                  className="img-fluid rounded"
                        ...
                        >
                          <div className="row align-items-center">
                                ...
                                <div className="thumb-container d-flex justify-content-center gap-2 mt-3">
                                  {["A2.jpeg", "A1.jpeg", "A5.jpeg", "A3.jpeg", "A4.jpeg", "A6.jpeg"].map((file, idx) => (
                                    <button
                                      ...
                                      className={`thumb-btn border rounded ${idx === 0 ? "active border-accent" : "border-secondary"}`}
                            ...
                            <div className="col-md-7">
                              ...
                              {/* Text */}
                              <div className="text-content px-2" data-aos="fade-up" data-aos-delay="100">
                                <p style={{ lineHeight: "1.8", textAlign: "justify" }}>
                          ...
                          <div className="col-md-7">
                            ...
                            <div data-aos="fade-up" data-aos-delay="100">
                              ...
                              <ul style={{ lineHeight: "1.8", paddingLeft: "20px" }}>
                                <li><strong>Inquirers:</strong> Curious and enthusiastic about learning. They develop skills for inquiry and research, and learn with independence and joy.</li>
                                <li><strong>Knowledgeable:</strong> Students explore concepts, ideas, and issues that have local and global significance, acquiring in-depth knowledge across disciplines.</li>
                                <li><strong>Thinkers:</strong> We encourage critical and creative thinking to analyze problems and take initiative to make reasoned decisions.</li>
                                <li><strong>Communicators:</strong> Confidently express themselves and work effectively in collaboration, listening and speaking in more than one language.</li>
                                <li><strong>Principled:</strong> Act with integrity, honesty, and a strong sense of fairness and justice, taking responsibility for their actions.</li>
                                <li><strong>Open-minded:</strong> Appreciate their own cultures and the perspectives of others. They are open to growing from diverse experiences.</li>
                                <li><strong>Caring:</strong> Show empathy, compassion, and respect. Committed to service and making a positive difference in the lives of others and the world around them.</li>
                                <li><strong>Risk-takers:</strong> Approach uncertainty with courage and forethought. They are resourceful and resilient in the face of challenges.</li>
                                <li><strong>Balanced:</strong> Understand the importance of intellectual, physical, and emotional balance to achieve well-being for themselves and others.</li>
                                <li><strong>Reflective:</strong> Thoughtfully consider their own learning and experiences. They assess and understand their strengths and limitations for personal growth.</li>
                              </ul>
                            ...
                            <div className="mt-4 d-block d-md-none" data-aos="fade-up">
