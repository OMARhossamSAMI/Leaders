...
export default function JobManagementPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setAcademicYear(
        `${String(baseYear).slice(2)}/${String(baseYear + 1).slice(2)}`
      );
                ...
                {jobs.map((job) => (
                  <div key={job._id} className="card">
                    ...
                    <p>
                      ...
                      <br />
                      <strong>Academic Year:</strong> {job.academicYear}
                      <br />
                      <strong>Start Year:</strong> {job.startYear}
                      <br />
                      <strong>End Year:</strong> {job.endYear}
                      <br />
                    ...
                    <div key={field.id || index} className="form-structure-box">
                      ...
                      {field.type === "file" && (
                        <div className="mt-2 text-info small">
                          📎 File upload field will allow users to attach a
                          file.
                        </div>
                      )}
