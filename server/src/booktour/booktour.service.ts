...
export class BookTourService {
  ...
  gradeApplyingFor: dto.gradeApplyingFor,  
    ...
    // Admissions email (HTML summary)
      ...
      <div style="font-family: Arial, sans-serif; background-color: #f4f6f9; padding: 30px; max-width: 750px; margin: auto; border-radius: 8px; border: 1px solid #d3d3d3; color:#000000;">
        ...
        <table border="1" cellpadding="6" cellspacing="0" style="width: 100%; border-collapse: collapse; background-color: #fff; margin-top: 20px;">
          ...
          <tbody>
            ...
            <tr><td style="padding:8px; font-weight:bold;">Parent Email</td>
                <td style="padding:8px;">
                  <a href="mailto:${parentEmail || ''}" style="color:#000000 !important; text-decoration:none !important;">${parentEmail || ''}</a>
                </td>
            </tr>
            ...
            <tr><td style="padding:8px; font-weight:bold;">Grade Applying For</td><td style="padding:8px;">${booking.gradeApplyingFor || dto.gradeApplyingFor || ''}</td></tr>
          </tbody>
        </table>
        <p style="margin-top: 30px; font-size: 13px; color: #000000;">This message was generated by the Leaders International College tour booking portal.</p>
      </div>`.trim();
    ...
    // Parent confirmation email (if email provided)
      const parentHtml = `
      <div style="font-family: Arial, sans-serif; background-color: #f7fafd; padding: 30px; max-width: 700px; margin: auto; border-radius: 8px; border: 1px solid #ccddee; color:#000000;">
        <h2 style="background-color: #004080; color: white; padding: 16px; text-align: center; border-radius: 6px;">
        ...
        <p style="font-size: 15px; margin-top: 16px;">
          <strong>Slot: </strong>${booking.selectedLabel || slot.label || '—'}<br/>
          <strong>Grade Applying For: </strong>${booking.gradeApplyingFor || dto.gradeApplyingFor || ''}
        </p>

        <p style="font-size: 15px; margin-top: 16px;">
          Location: <strong>Leaders International College</strong><br/>
          Campus: <strong> off 90th road, Fifth Settlemente</strong><br/>
          <a href="https://www.google.com/maps/place/Leaders+International+College/@30.016848,31.4631297,17z" target="_blank" style="color:#000000 !important; text-decoration:underline;">View on Google Maps</a>
        </p>
